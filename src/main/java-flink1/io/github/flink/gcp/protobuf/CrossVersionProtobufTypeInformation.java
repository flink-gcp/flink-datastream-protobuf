...
abstract class CrossVersionProtobufTypeInformation<T> extends TypeInformation<T> {
    ...
    /**
     * Bridges the legacy Flink 1.20 entry point to the shared serializer configuration API.
     *
     * @param config Flink execution configuration
     * @return a native serializer using the type information's settings
     */
    @Override
