...
class ProtobufRegistrationITCase {
    @Test
    @Timeout(120)
    void registersGeneratedMessagesAndTransportsAllFiveShapes() throws Exception {
        ...
        try (StreamExecutionEnvironment env =
            ...
            assertThat(messageInfo).isInstanceOf(ProtobufTypeInformation.class);
            assertThat(messageInfo.getTypeClass()).isEqualTo(ProbeMessage.class);
            assertThat(messageInfo).isEqualTo(ProtobufTypeInformation.of(ProbeMessage.class));
            assertThat(ProbeMessage.class.getSuperclass().getName())
                    .isIn(
